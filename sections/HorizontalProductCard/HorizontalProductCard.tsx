...
export function ErrorFallback({ error }: { error?:Error }) {
    return (
        <div class="error-fallback flex flex-col max-w-5xl mx-auto items-center">
            <img src="https://socialsahomolog.vtexassets.com/assets/vtex.file-manager-graphql/images/f8237baa-62c6-4b76-a4bc-f2aae3afc74c___fa63d90cf7d4fd2ceedad0c60fd963a4.png" alt="error image" class="error-ffallback-image" />
            <h3 className="fallback-error-title">OPS! Encontramos um problema :{"("}</h3>
...
const HorizontalProductCard = ({ image, productInfo }: HorizontalProductCardProps) => (
    <section class="horizontal-product-card-section flex">
        ...
        <div class="horizontal-product-card-details">
            ...
            <div class="horizontal-product-card-buy-">
                <span className="horizontal-product-card-price">{formatPrice(productInfo.price)}</span>
